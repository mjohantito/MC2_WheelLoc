...
class FoursquareAPI: ObservableObject {
    ...
    func fetchPlacesandImages() {
        ...
        let queryItems: [URLQueryItem] = [
            ...
            URLQueryItem(name: "categories", value: "13002"),
                        ...
                        do {
                           ...
                           // self.placeResults = []
                            ...
                            if let jsonString = String(data: jsonDataNew, encoding: .utf8) {
                                ...
                                addRecordToCloudKit( name: placeResult.name, address: placeResult.formatted_address!, category: "Restaurant", health_facilities_id: fsqIds, latitude: placeResult.latitude, longitude: placeResult.longitude, img_prefix: placeImgPrefix, img_suffix: placeImgSuffix, fsq_id: placeResult.fsq_id)
//                                print(jsonString)
                            }
                        } catch {
                            print("Error encoding JSON: \(error)")
