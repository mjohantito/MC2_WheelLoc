...
//    @AppStorage("userIdGlobal") var userIdGlobal: String = ""
    ...
    init(userFName: String, userLName: String, dateReview: Date, titleReview: String, descriptionReview: String, likesReview: Int, ratingReview: Double, ckRecordIdReview: CKRecord.ID, ckRecordIdPlace: CKRecord.Reference, /*userId: String,*/ isLiked: Bool) {
...
//        @AppStorage("userIdGlobal") var userIdGlobal: String = ""
//
//        ReviewCardView(userFName: "Angelo", userLName: "Kusuma", dateReview: Date(), titleReview: "Bagus Banget!", descriptionReview: "Disini fasilitas buat pengguna kursi roda aman banget, bahkan toiletnya disediain khusus buat disabilitas!", likesReview: 0, ratingReview: 1.0, ckRecordIdReview: CKRecord.ID(recordName: "3D204835-A7D5-4F80-8A7F-632C2CB1FBA8"), ckRecordIdPlace: CKRecord.Reference(recordID: response.ckRecordIdPlace, action:.none), userId: userId, isLiked: false)
//    }
//}
